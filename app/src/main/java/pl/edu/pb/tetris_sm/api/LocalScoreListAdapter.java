...
public class LocalScoreListAdapter extends ArrayAdapter<Score> {

    private Context context;
    private List<Score> ourDataSetList;

    public LocalScoreListAdapter(Context context, List<Score> ourDataSetList) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        Score ourDataSet = ourDataSetList.get(position);
